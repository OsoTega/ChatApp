...
if (document.getElementById) {
    ...
    // alert
    window.alert = function (title, alert_message, buttonText, buttonAction) {
        custom_alert(title, alert_message, buttonText, buttonAction);
    }
}
    
    function custom_alert(title, alert_message, buttonText, buttonAction) {
        ...
        const ALERT_BUTTON_TEXT = buttonText;
        ...
        alert_box.style.top = "20%";
        alert_box.style.left = "40%";
